...
class PersonalDataRepository(Protocol):
    ...
    def save_session(self, owner_id: str, session: ConversationSession, *, generation_id: str | None = None, revision: int | None = None, is_active=None) -> bool: ...
    ...
    def apply_user_memory_control(self, owner_id: str, session_key: str, control: MemoryControl, *, expected_generation_id: str | None = None, expected_revision: int | None = None, is_active=None) -> MemoryGovernanceResult: ...
    ...
    def validate_purge_window(self, start_at: str, end_at: str) -> None: ...
    def list_owners(self) -> tuple[str, ...]: ...
    def purge_owner_window(self, owner_id: str, start_at: str, end_at: str, *, before_purge: Callable[[Iterable[dict[str, object]]], None] | None = None) -> dict[str, int]: ...
